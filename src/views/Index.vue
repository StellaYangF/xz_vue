          ...
          <div class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="`/details/${products[0].href.split('=')[1]}`">查看详情</router-link>
              </div>
              <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" :src="products[0].pic" data-holder-rendered="true">
            </div>
          </div>
          <div class="col-md-5 pl-0">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="`/details/${products[1].href.split('=')[1]}`">查看详情</router-link>
              </div>
              <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" :src="products[1].pic" data-holder-rendered="true">
            </div>
          </div>
        </div>
        <div class="row mb-2">
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="`/details/${products[2].href.split('=')[1]}`">查看详情</router-link>
              </div>
              <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" :src="products[2].pic" data-holder-rendered="true">
            </div>
          </div>
          <div class="col-md-7 pl-0">
            <div class="row pr-3">
              <div v-for="(p,i) of products.slice(-3)" :key="i" class="col-md-4 p-0 pl-2">
...
<script>
export default {//一个组件对象
  data(){
    return {
      products:[
        {title:"",details:"",price:0,href:""},
        {title:"",details:"",price:0,href:""},
        {title:"",details:"",price:0,href:""}
      ]
    }
  },
  created(){//生命周期钩子函数: 当data对象创建完自动触发
